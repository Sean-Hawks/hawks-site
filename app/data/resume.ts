...
export const resumeItems: ResumeItem[] = [
  ...
  },
  {
    ...
    dateTime: "2026-07-14",
    categories: ["音樂發表"],
    title: "《Harmony》｜大安管樂第 63 屆獨立大成",
    organization: "大安高工管樂團",
    summary: "參與大安高工管樂團第 63 屆獨立成果發表會。",
  ...
  },
  {
    ...
    dateTime: "2025-12-20",
    categories: ["音樂發表"],
    title: "《SYMPHONIA》｜大安 × 南湖 × 西松三校管樂聯合小成",
    organization: "大安高工、南湖高中、西松高中管樂團",
    summary: "參與大安、南湖與西松三校管樂團聯合成果發表會。",
  ...
  },
  {
    ...
    dateTime: "2025-07-04",
    categories: ["音樂發表"],
    title: "《Résonance 共鳴》｜大安管樂第 62 屆獨立大成",
    organization: "大安高工管樂團",
    summary: "參與大安高工管樂團第 62 屆獨立成果發表會。",
    tags: ["Wind Band", "Concert", "Performance"],
  },
  {
    period: "2025.07",
  ...
  },
  {
    ...
    dateTime: "2024-12-28",
    categories: ["音樂發表"],
    title: "《IMMORTAL》｜華江 × 大安 × 金甌三校管樂聯合小成",
    organization: "華江高中、大安高工、金甌女中管樂團",
    summary: "參與華江、大安與金甌三校管樂團聯合成果發表會。",
    tags: ["Wind Band", "Concert", "Collaboration"],
  },
  {
    period: "2024.10.28",
