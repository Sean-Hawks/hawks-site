    ...
    <div className="site-shell min-h-screen text-[rgb(var(--text))]">
      ...
      <div className="w-full px-4 sm:px-3">
        <main className="mx-auto max-w-6xl py-8">
          ...
          {latestTalk && (
            <div className="mb-16 rounded-2xl border border-[rgb(var(--accent)/0.22)] bg-[rgb(var(--accent)/0.07)] p-6 shadow-[0_22px_70px_rgba(90,76,55,0.10)] sm:p-8 relative overflow-hidden">
            ...
            <div className="space-y-12">
              {otherTalks.map((talk) => (
                <div key={talk.id} id={talk.id} className="relative scroll-mt-24 pl-8 border-l border-[rgb(var(--line)/0.12)]">
                  ...
                  <div className="rounded-xl border border-[rgb(var(--line)/0.10)] bg-[rgb(var(--panel)/0.84)] p-6 shadow-[0_18px_60px_rgba(90,76,55,0.07)] transition-colors hover:border-[rgb(var(--accent)/0.28)] hover:bg-[rgb(var(--panel))]">
