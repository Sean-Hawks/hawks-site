    ...
    <div className="mt-4 text-sm" data-print-hide>
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-lg border border-[rgb(var(--accent)/0.25)] bg-[rgb(var(--accent)/0.07)] px-3 font-medium text-[rgb(var(--accent))]"
        >
        ...
        <Link
          href="/saved/"
          className="inline-flex min-h-11 items-center text-xs text-[rgb(var(--muted))] hover:text-[rgb(var(--accent))]"
        >
          檢視清單
        </Link>
      </div>
